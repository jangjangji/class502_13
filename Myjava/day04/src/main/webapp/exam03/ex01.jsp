...
리벨리온은 2020년 박성현 대표와 오진욱 최고기술책임자(CTO) 등이 공동 창업한 AI반도체 팹리스 스타트업이다. 현재 거대언어모델 시장을 겨냥한 '리벨(REBEL)'을 개발 중이다.서울=뉴스1) 양새롬 기자 = 인공지능(AI) 반도체 기업인 사피온코리아와 리벨리온이 합병한다. 빠르게 변화하는 시장 상황에 민첩하게 대응하기 위해 리벨리온이 합병법인의 경영을 맡을 예정이다.
...
<jsp:forward page="ex02.jsp" /><%@ page contentType="text/html; charset=UTF-8" %>
<%@ page buffer="1kb" %>
서울=뉴스1) 양새롬 기자 = 인공지능(AI) 반도체 기업인 사피온코리아와 리벨리온이 합병한다. 빠르게 변화하는 시장 상황에 민첩하게 대응하기 위해 리벨리온이 합병법인의 경영을 맡을 예정이다.
